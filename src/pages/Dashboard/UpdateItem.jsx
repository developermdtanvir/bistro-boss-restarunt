    ...
    return (
        <div>
            <div className="flex justify-center items-center py-10">
                <h1 className="text-3xl">UPDATE ITEM</h1>
            </div>
            <div className="lg:w-[700px] w-full lg:p-20 p-5 bg-base-200 my-10 rounded-md">
                <SectionTitle heading={'ADD AN ITEM'} subHeading={'What`s new ?'} />
                <div>
                    <form {...register('form')} onSubmit={handleSubmit(handleUpdateItem)} className="space-y-10">
